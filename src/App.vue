    ...
    <div>
      <button class="fixed bottom-5 right-5 ">
        ...
        <div @click="toggleDark()"  >
          ...
          <svg v-if="!isDark" ref="day" class="w-8 h-8 md:w-10 md:h-10 relative rounded-full transition duration-500 transform bg-yellow-500 -translate-x-2 p-1 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
          </svg>
          <svg v-if="isDark" ref="night" class="w-8 h-8 md:w-10 md:h-10 relative rounded-full transition duration-500 transform bg-blue-900 -translate-x-2 p-1 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" /></svg>
  ...
  <header>
    <nav class="h-30 w-screen  space-x-8 pr-36 pt-8 flex justify-end sm:flex-row relative">  
      <div class="h-20 w-20 flex-1 pl-10 block">
        ...
        <img v-if="!isDark" src=" ./src/assets/Amicon.png " class="object-scale-down h-20  w-20 font-bold font-sans flex-1 pb-2 -mt-4 transition-all ">
        <img v-if="isDark" src=" ./src/assets/AmiconDarkMode.png " class="object-scale-down h-20  w-20 font-bold font-sans flex-1 pb-2 -mt-4 transition-all ">
      </div>
